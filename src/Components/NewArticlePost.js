...
class NewArticlePost extends React.Component {
  constructor(props) {
    ...
    this.state = {
      title: 'Gains & Pains',
      description: 'Smoking can kill your gains',
      body: 'Smoking can kill your gains Smoking can kill your gains Smoking can kill your gains Smoking can kill your gains Smoking can kill your gains Smoking can kill your gains Smoking can kill your gains',
      tagsList: ['gym', 'pump', 'working_out'],
      errors: {
        title: '',
        description: '',
        body: '',
  ...
  handleSubmit = (e) => {
    let { title, description, body, tagsList, errors } = this.state;
    e.preventDefault();
    fetch(articlesURL, {
      method: 'POST',
      headers: {
